...
class DeepQNetwork():
    def __init__(self,state_size, action_size, seed):
        ...
        self.optimizer=optim.Adam(self.Q.parameters(),ALPHA)
    ...
    def learn(self,experiences,GAMMA):
        ...
        with T.no_grad():  # No gradient tracking for Q_target
            ...
            max_next_Q = next_Q_values.detach().max(dim=1)[0].unsqueeze(1)  # Get max Q-value for each next state
